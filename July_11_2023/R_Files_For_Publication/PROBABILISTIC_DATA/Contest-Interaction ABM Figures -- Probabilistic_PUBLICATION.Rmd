---
title: "Contest-Interaction ABM Figures -- Probabilistic"
...
attack.prop.3.p<-attack.prop.2.p[attack.prop.2.p$X.3=="mutual",]
...
overall.ss.prob.mut<-overall.ss.prob[overall.ss.prob$strategy=="mutual",]

f2a <- overall.ss.prob.mut %>%
...
jpeg("contest.comp_Supplement_figure_2a.jpeg", 336, 336)
f2a
dev.off()

f2b <- overall.ss.prob.mut %>%
...
geom_boxplot(outlier.shape=NA) +
    ...
    coord_cartesian(expand=F, clip="off", xlim=c(0.25, 2.75), ylim=c(-0.05,1.05))
jpeg("contest.comp_Supplement_figure_2b.jpeg", 336, 336)
f2b
dev.off()
    
f2c <- overall.ss.prob.mut %>%
  ...
  geom_boxplot(outlier.shape=NA) +
    ...
    annotate(geom="text", x=c(1.5, 3.5, 5.5), y=-0.15, label=c("Mutual"), size=5)+
    coord_cartesian(expand=F, clip="off", xlim=c(0.25, 2.75), ylim=c(-0.05,1.05))
jpeg("contest.comp_Supplement_figure_2c.jpeg", 336, 336)
f2c
dev.off()
...
f4<-plot(total.energy.pc$energy_over_time~total.energy.pc$normDS,pch=1,cex=1.4,xaxt="n",yaxt="n",col="blue",xlab="",ylab="",main="",ylim=c(0.4,0.8),xlim=c(0.85,8.25),las=1); points(total.energy.pu$energy_over_time~total.energy.pu$normDS,pch=2,cex=1.4,col="#CC5500"); abline(km.lm.pc, lwd=3);abline(hm.lm.pc, lwd=3);abline(km.lm.pu, col="black", lty=4, lwd=3);abline(hm.lm.pu, col="black", lty=4, lwd=3);title(xlab="Normalized David's Scores",line=1.25);title(ylab="Energy per unit Time", line=1.5); axis(1, at = c(0, 1, 2, 3, 4, 5, 6, 7, 8), label=rep("",9), tck=-0.015, line=0);axis(2, at = c(0.4,0.5,0.6,0.7,0.8), label=rep("",5),tck=-0.015);axis(1, at = 1:10, line = -0.8, lwd = 0, cex.axis = 1);axis(2, at = c(0.4,0.5,0.6,0.7,0.8), line = -0.7, lwd = 0, cex.axis = 1, las=1);box(col="black",lwd=3)
dev.off()
...
overall.ss.prob.avoid.mut<-overall.ss.prob.uniform.avoid[overall.ss.prob.uniform.avoid$strategy=="mutual",]

f14a <- overall.ss.prob.avoid.mut %>%
  ggplot( aes(x=combo2, y=triangle.transitivity,color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f14b <- overall.ss.prob.avoid.mut %>%
  ggplot( aes(x=combo2, y=dci,color=distribution)) +
geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f14c <- overall.ss.prob.avoid.mut %>%
  ggplot( aes(x=combo2, y=abs(steepness),color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
overall.ss.prob.attacks.mut<-overall.ss.prob.uniform.attacks[overall.ss.prob.uniform.attacks$strategy=="mutual",]

f18a <- overall.ss.prob.attacks.mut %>%
  ggplot( aes(x=combo2, y=triangle.transitivity,color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f18b <- overall.ss.prob.attacks.mut %>%
  ggplot( aes(x=combo2, y=dci,color=distribution)) +
geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f18c <- overall.ss.prob.attacks.mut %>%
  ggplot( aes(x=combo2, y=abs(steepness),color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
overall.ss.prob.initiator.2<-overall.ss.prob.initiator[overall.ss.prob.initiator$strategy=="mutual",]


f21a <- overall.ss.prob.initiator.2 %>%
...
f21b <- overall.ss.prob.initiator.2 %>%
  ggplot( aes(x=combo2, y=dci,color=distribution)) +
geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f21c <- overall.ss.prob.initiator.2 %>%
  ggplot( aes(x=combo2, y=abs(steepness),color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
overall.ss.initiator.avoid.prob.mut<-overall.ss.initiator.avoid.prob[overall.ss.initiator.avoid.prob$strategy=="mutual",]

f22a <- overall.ss.initiator.avoid.prob.mut %>%
  ggplot( aes(x=combo2, y=triangle.transitivity,color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f22b <- overall.ss.initiator.avoid.prob.mut %>%
  ggplot( aes(x=combo2, y=dci,color=distribution)) +
geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f22c <- overall.ss.initiator.avoid.prob.mut %>%
  ggplot( aes(x=combo2, y=abs(steepness),color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
overall.ss.initiator.attacks.prob.mut<-overall.ss.initiator.attacks.prob[overall.ss.initiator.attacks.prob$strategy=="mutual",]

f23a <- overall.ss.initiator.attacks.prob.mut %>%
  ggplot( aes(x=combo2, y=triangle.transitivity,color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f23b <- overall.ss.initiator.attacks.prob.mut %>%
  ggplot( aes(x=combo2, y=dci,color=distribution)) +
geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f23c <- overall.ss.initiator.attacks.prob.mut %>%
  ggplot( aes(x=combo2, y=abs(steepness),color=distribution)) +
  geom_boxplot(outlier.shape=NA) +
    geom_point(aes(shape=distribution),size=2.5,position=position_dodge(width=0.75))+
    scale_shape_manual(values=c(1, 2))+
...
f24<-plot(total.energy.ic.p$energy_over_time~total.energy.ic.p$normDS,pch=1,cex=1.4,xaxt="n",yaxt="n",col="blue",xlab="",ylab="",main="",ylim=c(0.4,0.8),xlim=c(0.85,8.25),las=1); points(total.energy.iu.p$energy_over_time~total.energy.iu.p$normDS,pch=2,cex=1.4,col="#CC5500"); abline(km.lm.ic.p, lwd=3);abline(hm.lm.ic.p, lwd=3);abline(km.lm.iu.p, col="black", lty=4, lwd=3);abline(hm.lm.iu.p, col="black", lty=4, lwd=3);title(xlab="Normalized David's Scores",line=1.25);title(ylab="Energy per unit Time", line=1.5); axis(1, at = c(0, 1, 2, 3, 4, 5, 6, 7, 8), label=rep("",9), tck=-0.015, line=0);axis(2, at = c(0.4,0.5,0.6,0.7,0.8), label=rep("",5),tck=-0.015);axis(1, at = 1:10, line = -0.8, lwd = 0, cex.axis = 1);axis(2, at = c(0.4,0.5,0.6,0.7,0.8), line = -0.7, lwd = 0, cex.axis = 1, las=1);box(col="black",lwd=3)
dev.off()


#Base Wins VS Initiator Wins

initiator.wins.prop.2<-subset(initiator.wins.prop.prob,select = -c(calculation))
initiator.wins.prop.2<-initiator.wins.prop.2[initiator.wins.prop.2$assessment=="mutual",]

rhp.initiator.prop.attack.df<-data.frame(run.number=attack.prop.3.p$run.number, dist=attack.prop.3.p$X.1, interaction=attack.prop.3.p$X.2, assessment=attack.prop.3.p$X.3, step=attack.prop.3.p$X.4, ticks=attack.prop.3.p$X.5, victory.count=attack.prop.3.p$X.6, sum.avoids=attack.prop.3.p$X.7, efficiency=attack.prop.3.p$X.8, attack.proportion=as.numeric(attack.prop.3.p$X.10), combo2=attack.prop.3.p$combo2)

rhp.initiator.prop.attack.df<-rhp.initiator.prop.attack.df[rhp.initiator.prop.attack.df$interaction=="knowledge",]

initiator.wins.prop.3<-initiator.wins.prop.2[,1:11]

rhp.initiator.prop.attack.df<-rbind(rhp.initiator.prop.attack.df, initiator.wins.prop.3[initiator.wins.prop.3$interaction=="history",])
...
rhp.initiator.df<-overall.ss.prob.mut[overall.ss.prob.mut$variable=="rhp",]
rhp.initiator.df<-rbind(rhp.initiator.df,overall.ss.prob.initiator.2[overall.ss.prob.initiator.2$variable=="history",])
...
rhp.initiator.df.attacks<-overall.ss.prob.attacks.mut[overall.ss.prob.attacks.mut$variable=="rhp",]
rhp.initiator.df.attacks<-rbind(rhp.initiator.df.attacks,overall.ss.initiator.attacks.prob.mut[overall.ss.initiator.attacks.prob.mut$variable=="history",])
...
rhp.initiator.df.avoids<-overall.ss.prob.avoid.mut[overall.ss.prob.avoid.mut$variable=="rhp",]
rhp.initiator.df.avoids<-rbind(rhp.initiator.df.avoids,overall.ss.initiator.avoid.prob.mut[overall.ss.initiator.avoid.prob.mut$variable=="history",])
